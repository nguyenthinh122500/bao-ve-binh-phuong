    ...
    n = function (t, G, q, i, B, C, y, z) {
      ...
      u = function () {
        ...
        if (r) {
          ...
          t.css({ position: "", top: "", width: "", bottom: "" }).removeClass(
            g
          );
          K = true;
        }
      ...
      E = function () {
        ...
        if (r) {
          if (o) {
            ...
            if (D && !J) {
              D = false;
              t.css({ position: "fixed", bottom: "", top: s }).trigger(
                "sticky_kit:unbottom"
              );
            }
          }
        ...
        if (r && o) {
          ...
          if (!D && J) {
            ...
            return t
              .css({ position: "absolute", bottom: G, top: "auto" })
      ...
      H = function () {
        ...
        t.css({ position: "", bottom: "", top: "", width: "" });
        w.position("position", "");
        if (r) {
          if (f == null) {
            if (y === "left" || y === "right") {
